        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ForgotPasswordOtpHash = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ForgotPasswordOtpExpiredAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SystemValue = table.Column<int>(type: "int", maxLength: 500, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Conversations_AppUsers_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmailLogs_AppUsers_ReceiverId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SellerRequests_AppUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name_NoAccent = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    BiddingCount = table.Column<int>(type: "int", nullable: false),
                    IsAutoRenewal = table.Column<bool>(type: "bit", nullable: false),
                    Description_NoAccent = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    PaymentInvoiceUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShippingPhone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShippingInvoiceUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_AppUsers_SellerId",
                        column: x => x.SellerId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "AutomatedBiddings",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MaxBidAmount = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AutomatedBiddings", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AutomatedBiddings_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BiddingHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BiddingHistories_AppUsers_BidderId",
                        column: x => x.BidderId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BiddingHistories_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BlackLists_AppUsers_BidderId",
                        column: x => x.BidderId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BlackLists_AppUsers_SellerId",
                        column: x => x.SellerId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ratings_AppUsers_RatedUserId",
                        column: x => x.RatedUserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Ratings_AppUsers_RaterId",
                        column: x => x.RaterId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Watchlists_AppUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MessageReadStatuses_AppUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), null, "Bidder", "BIDDER" },
                    { new Guid("22222222-2222-2222-2222-222222222222"), null, "Seller", "SELLER" },
                    { new Guid("22222222-2222-2222-3333-222222222222"), null, "User", "User" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("13333333-3333-3333-3333-333333333333"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "ExtraRenewalTime", 10, null },
                    { new Guid("23333333-3333-3333-3333-333333333333"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "RenewalTriggerTime", 5, null },
                    { new Guid("33333333-3333-3333-3333-333333333333"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "NewProductTime", 5, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AutomatedBiddings_BidderId",
                table: "AutomatedBiddings",
                column: "BidderId");

            migrationBuilder.CreateIndex(
                name: "IX_AutomatedBiddings_ProductId",
                table: "AutomatedBiddings",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_BiddingHistories_BidderId",
                table: "BiddingHistories",
                column: "BidderId");

            migrationBuilder.CreateIndex(
                name: "IX_BiddingHistories_ProductId",
                table: "BiddingHistories",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_BlackLists_BidderId",
                table: "BlackLists",
                column: "BidderId");
